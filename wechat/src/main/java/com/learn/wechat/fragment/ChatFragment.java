...
import com.learn.wechat.widget.emojicon.EaseEmojiconMenu;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragment.EaseChatFragmentHelper {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return super.onCreateView(inflater, container, savedInstanceState,
                ChatHelper.getChatHelper().getUserModel().isMsgRoaming() && (chatType != EaseConstant.CHATTYPE_CHATROOM));
    }

    @Override
    protected boolean turnOnTyping() {
        return ChatHelper.getChatHelper().getUserModel().isShowMsgTyping();
    }
    ...
    protected void setUpView() {
        ...
        if (chatType == Constant.CHATTYPE_SINGLE) {
            Map<String,RobotUser> robotMap = ChatHelper.getChatHelper().getRobotList();

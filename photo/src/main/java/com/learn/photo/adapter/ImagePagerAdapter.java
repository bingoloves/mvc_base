...
public class ImagePagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        if (image.isGif()) {
            ...
            PhotoHelper.get().getImageLoader().displayGif(isAndroidQ ? UriUtils.getPathForUri(mContext,image.getUri()) : image.getPath(),currentView);
...
//                    .into(currentView);
            ...
            PhotoHelper.get().getImageLoader().displayImage(isAndroidQ ? UriUtils.getPathForUri(mContext,image.getUri()) : image.getPath(),currentView);
...
//            });
    ...
    private void adjustOffset(PhotoView view, float offset) {
        ...
        try {
            mAttacher = view.getClass().getDeclaredField("mAttacher");
            attacher = (PhotoViewAttacher) mAttacher.get(view);

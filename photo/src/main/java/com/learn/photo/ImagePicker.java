...
import com.learn.photo.activity.ClipImageActivity;
import com.learn.photo.activity.ImageSelectorActivity;
...
public class ImagePicker {
    ...
    public static class ImagePickerBuilder {
         ...
         * @return
         */
        public ImagePickerBuilder setCropRatio(float ratio) {
         ...
         * @return
         */
        public ImagePickerBuilder canPreview(boolean canPreview) {
        ...
        public ImagePickerBuilder onlyTakePhoto(boolean onlyTakePhoto) {

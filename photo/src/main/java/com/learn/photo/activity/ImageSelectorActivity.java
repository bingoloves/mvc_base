...
import com.learn.photo.adapter.FolderAdapter;
import com.learn.photo.adapter.ImageAdapter;
import com.learn.photo.bean.Folder;
import com.learn.photo.bean.Image;
import com.learn.photo.bean.RequestConfig;
import com.learn.photo.model.ImageModel;
import com.learn.photo.utils.DateUtils;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, int requestCode, RequestConfig config) {
        ...
        intent.putExtra(ImagePicker.KEY_CONFIG, config);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RequestConfig config = intent.getParcelableExtra(ImagePicker.KEY_CONFIG);
...
//        }).start();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ImagePicker.RESULT_CODE) {
            ...
            if (VersionUtils.isAndroidQ()) {
                ...
                if (photoFile != null) {
                    ...
                    if (VersionUtils.isAndroidN()) {
                        ...
                        photoUri = FileProvider.getUriForFile(this, getPackageName() + ".imagePickerProvider", photoFile);
                    } else {

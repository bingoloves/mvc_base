...
import com.learn.photo.adapter.ImagePagerAdapter;
import com.learn.photo.bean.Image;
import com.learn.photo.utils.VersionUtils;
import com.learn.photo.view.MyViewPager;
...
public class PreviewActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, ArrayList<Image> images,
        ...
        activity.startActivityForResult(intent, ImagePicker.RESULT_CODE);
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMaxCount = intent.getIntExtra(ImagePicker.MAX_SELECT_COUNT, 0);
        isSingle = intent.getBooleanExtra(ImagePicker.IS_SINGLE, false);
        ...
        vpImage.setCurrentItem(intent.getIntExtra(ImagePicker.POSITION, 0));
    }
    ...
    public void finish() {
        ...
        setResult(ImagePicker.RESULT_CODE, intent);
        super.finish();
    }
}
